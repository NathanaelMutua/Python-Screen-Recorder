...
# Background images
image1 = PhotoImage(file="white.png")
Label(root, image = image1, bg="#bcbfbf").place(x=2,y=35)

image2 = PhotoImage(file="black.png")
...
image6 = PhotoImage(file="stop_button.png")
